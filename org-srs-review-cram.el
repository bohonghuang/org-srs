...
(cl-defmethod org-srs-algorithm-repeat :around (_ args &context (org-srs-review-cram-algorithm org-srs-review-cram-algorithm))
  ...
  (let ((algorithm org-srs-review-cram-algorithm)
    ...
    (setf (gethash
           (cl-multiple-value-list (apply #'org-srs-item-full org-srs-review-item))
           (org-srs-review-cram-algorithm-ratings algorithm))
          rating)
    nil))
              ...
              = (when (eq major-mode 'org-mode)
                  (save-excursion
                    ...
                    (ignore-errors
                      ...
                      (cl-multiple-value-list (org-srs-item-full)))))
                  ...
                  (continue ()
                    (if (org-srs-reviewing-p)
                        (progn
                          ...
                          (org-srs-item-add-hook-once 'org-srs-review-continue-hook #'continue 10))
