...
While reviewing, the following keybindings are available

- Key: f5 (org-srs-review-rate-easy) ::
- Key: f6 (org-srs-review-rate-good) ::
- Key: f7 (org-srs-review-rate-hard) ::
- Key: f8 (org-srs-review-rate-again) ::

  Rate your performance on the last card.

- Key: f9 (org-srs-review-quit) ::
